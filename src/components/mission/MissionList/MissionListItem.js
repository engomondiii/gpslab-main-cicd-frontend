 ...
 * Integrates with StageCard status system and Baraka rewards.
 * 
  ...
  return (
    ...
    >
      ...
      <div className={`mission-list-item__type mission-list-item__type--${type}`}>
        {TypeIcon}
        {isPartyMission && (
          <span className="mission-list-item__party-badge">
            {partySize || '2-8'}
          </span>
        )}
      </div>
          ...
          <div className="mission-list-item__title-row">
            ...
            {missionNumber && (
              <span className="mission-list-item__number">
                {stageNumber && `S${stageNumber}.`}M{missionNumber}
              </span>
            )}
