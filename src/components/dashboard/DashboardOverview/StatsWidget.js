 ...
 * 
 * UPDATED: GPS 101 Integration - Added GPS 101 and Orange Beacon icons
 * 
...
const StatIcons = {
  ...
  orange_beacon: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <circle cx="12" cy="12" r="10" fill="#f39c12" opacity="0.3"/>
      <circle cx="12" cy="12" r="6" fill="#f39c12"/>
      <path d="M12 6v6l4 2" stroke="#fff" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
